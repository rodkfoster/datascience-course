...
For this class, we suggest one of the following:
1. **Use Intuit data** (most prefered)
2. Make your own dataset
3. Compete in a Kaggle competition
4. Analyze a complex dataset or merge several
5. Implement a paper on a new dataset

However, other options can be available. For example, complementing an existing workflow with Python scripting could  be a project if sufficiently complex.
...
+ [Wayback Machine API](https://archive.org/help/wayback_api.php). Retrieve snapshots of websites at specific points in time. Very useful for making your own dataset.

### Finance-specific Datasets

+ [IRS Form 990 Data](https://www.kaggle.com/irs/irs-990/home). Form 990: Return of Organization Exempt From Income Tax. Often is the only source of financial information about nonprofit organizations.

+ [Individual Income Tax Statistics](https://www.kaggle.com/irs/individual-income-tax-statistics). 

+ [NY Property Tax Bills](https://www.reddit.com/r/bigquery/comments/73fgqw/new_york_city_property_tax_bills_bigquery_datasets/). Google BigQuery, Map Data, IRS.

+ [Home Mortgage Disclosure Act Data](https://www.consumerfinance.gov/data-research/hmda/). Contains location, property, loan, lender, and applicant data. 

+ [Complete History of Bitcoin Trading Markets](https://bitcoincharts.com/about/markets-api/). Note there is also the [raw history data](http://api.bitcoincharts.com/v1/csv/).

+ [Bitcoin Blockchain Data](https://www.kaggle.com/bigquery/bitcoin-blockchain). Trades to/from wallets.