...
2. Make a list of all of the CSV or TSV files in the repo (using a single command). Think about how wildcard characters can help you with this task.
3. Count the number of occurrences of the word 'dictionary' (regardless of case) across all files in the repo.
