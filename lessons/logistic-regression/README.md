...
| --- | --- | --- |
| Lesson | Logistic Regression | [Here](./01-Logistic-Regression-Lesson.ipynb) |
| Solution  | Solution code for lesson prompts | [Here](./solution-code/01-Logistic-Regression-Lesson_Solutions.ipynb) |
|Optional Lesson | Understanding Support Vector Machines | [Here](./02-Logistic-Regression-and-SVMs.ipynb) |
